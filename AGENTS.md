# Agent guidance – wp-module-atomic

This file gives AI agents a quick orientation to the repo. For full detail, see the **docs/** directory.

## What this project is

- **wp-module-atomic** – A module to customize a brand plugin for WP Cloud environments. Registers with the Newfold Module Loader; depends on wp-module-context. Maintained by Newfold Labs.

- **Stack:** PHP 7.4+. See docs/dependencies.md.

- **Architecture:** Registers with the loader; provides Atomic/WP Cloud customization. See docs/integration.md.
